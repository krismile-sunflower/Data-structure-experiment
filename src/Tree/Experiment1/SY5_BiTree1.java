        ...
        while (true){
            ...
            switch (i){
                ...
                case 3:
                    ...
                    System.out.println();break;
                case 4:
                    int m = T.countNode(T.getRoot());
                    System.out.print("二叉树的结点个数为：" + m);
                    System.out.println();break;
                case 5:
                    int n = T.countLeafNode(T.getRoot());
                    System.out.print("二叉树的叶结点个数为：" + n);
                    System.out.println();break;
                case 6:
                    return;
            }
