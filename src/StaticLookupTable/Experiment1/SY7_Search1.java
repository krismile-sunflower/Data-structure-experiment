package StaticLookupTable.Experiment1;

import StaticLookupTable.KeyType;
import StaticLookupTable.RecordNode;
import StaticLookupTable.SeqList;
...
public class SY7_Search1 {
     ...
     * @throws Exception
     */
    public static void createdSearchList() throws Exception {
        ST = new SeqList(20);
